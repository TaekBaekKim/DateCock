...
<input type="text" id="reasonText" class="hidden" placeholder="기타 사유를 입력해주세요.">
      ...
      <div class="buttons">
        <button type="button" class="btn-secondary" onclick="location.href='mypage'">취소</button>
  ...
  <div class="container hidden" id="step2">
    ...
    <div class="section">
      ...
      <div class="info-box">
        <p><strong>이용 중인 DateKock ID</strong>: ${sessionScope.id}</p>
    ...
    <form action="${pageContext.request.contextPath}/userdelete1" method="post" onsubmit="return confirmDelete();">
