  ...
  <div class="cotn_principal">
    <div class="cont_forms" id="formWrapper">
      <div class="cont_img_back_">
        <img src="./image/DateCocklogo.png" alt="background image">
      </div>
      ...
      <div class="cont_form_sign_up" id="signupForm">
        ...
        <form action="businessupdategogogo" method="post" enctype="multipart/form-data">
          <input type= "text" name="businessnumber" value="${dto.businessnumber}" readonly="readonly" />
          <input type="text" name="businessname" value="${dto.businessname}" required="required" />
          <input type="text" name="address" value="${dto.address}"  required="required"/>
          <input type="text" name="businesstime" value="${dto.businesstime}" required="required"  />
          <input type="text" name="phone" value="${dto.phone}" required="required" />
          <center>
          <img src="./image/${dto.image}" width="120px" height="80px">
          </center>
          <input type="hidden" name="deleteimage" value="${dto.image}">
          <input type="hidden" name="goimage" value="${dto.image}">
     	  <label for="image" class="file-label">👉 수정 할 이미지를 넣어주세요    (클릭)👈</label>
		  <input type="file" id="image" name="image"  />
          <input type="text" name="information" value="${dto.information}" required="required"/>
...
<div class="floating-box">
  ...
  <div class="box-content">
    ...
    <button class="subscribe-button">상담하러 가기</button>
  </div>
